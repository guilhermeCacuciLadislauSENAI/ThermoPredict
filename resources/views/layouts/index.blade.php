...
<body>
    ...
    <nav>
        @if (auth()->check() && auth()->user()->perfil === 'admin')
            ...
            <a href="{{ route('admin.pendencias') }}"
                class="{{ request()->routeIs('admin.pendencias') ? 'ativo' : '' }}">Aprova&ccedil;&otilde;es Pendentes</a>
        @else
            <a href="{{ route('dashboard') }}"
                class="{{ request()->routeIs('dashboard') ? 'ativo' : '' }}">Dashboard</a>
            <a href="{{ route('predicao') }}"
                class="{{ request()->routeIs('predicao*') ? 'ativo' : '' }}">Intelig&ecirc;ncia T&eacute;rmica</a>
            ...
            <a href="{{ route('relatorios') }}"
                class="{{ request()->routeIs('relatorios') ? 'ativo' : '' }}">Relat&oacute;rios</a>
        @endif
    ...
    <footer class="rodape">
        <p>THERMO PREDICT &copy; {{ date('Y') }} &middot; Monitoramento Inteligente da Cadeia Fria</p>
    </footer>
